  ...
  return (
    <>
      <div
        ...
        } transition-all i-carbon-bookmark-add text-5 mr-3 cursor-pointer opacity-animation-3`}
      />
      <div
        onClick={() => toggleEditMode()}
        className={`${
          isEdit ? "i-carbon-edit-off" : "i-carbon-edit"
        } text-5 cursor-pointer icon-tap-color mr-3 opacity-animation-3 `}
      />
